...
@section('konten')
<title>Fruts Cafe - Lapor Pengunjung Surabaya</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Laporan Pengunjung - Surabaya</h4>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
												<form method="post" action="/laporpengunjungsby/store " >
                                                {{ csrf_field() }}
                                    ...
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        @foreach($laporpengunjungsby as $l)
                                            <tr>
                                                ...
                                                <td>{{ $l->laporjumlah_sby }}</td>
												<td>
                                                {{-- <a type="button" href="/laporpengunjungsby/laporpengunjungeditsby/{{ $l->id }}" class="btn btn-warning btn-xs mb-12">Edit</a> --}}
												<a type="button" href="/laporpengunjungsby/hapus/{{ $l->id }}" class="btn btn-danger btn-xs  mb-12">Hapus</a>
												</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
