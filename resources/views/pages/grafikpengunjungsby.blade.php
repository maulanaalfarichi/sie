...
@section('konten')
<title>Laporan Pengunjung Surabaya</title>
            ...
            <script>
                $(document).ready(function() {
                    var options = {
                        ...
                        title: {},
                        subtitle: {
                            text: 'Grafik laporan pengunjung di cabang Surabaya.'
                        },
                        xAxis: {
                            type: 'category'
                        },
                    ...
                    function getDataSale() {
                        $.ajax({
                            type: "GET",
                            dataType: "json",
                            url: "{{ route('report.sumPengunjungSby') }}",
